...
DiplomaTextPointersAndCoords:
	; x, y, text
	diploma_text  12,  2, DiplomaText
	diploma_text  13,  4, DiplomaPlayer
	diploma_text   5,  4, DiplomaEmptyText
	diploma_text  17,  6, DiplomaCongrats
	diploma_text  15, 14, DiplomaGameFreak
