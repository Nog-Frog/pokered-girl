...
; commands that are used to go to the next set of credits texts.
	...
	db CRED_IL_STAFF, CRED_TEXT_FADE
	db CRED_IL_PRODUCTION, CRED_NOGA, CRED_TEXT_FADE_MON
	db CRED_PROGRAMMERS, CRED_NOGA, CRED_EYAL, CRED_TEXT_FADE
	db CRED_IL_TRANS, CRED_NOGA, CRED_MAAYAN, CRED_SHARON, CRED_TEXT_FADE
	db CRED_IL_TRANS, CRED_NOAM, CRED_ELBOIM, CRED_TEXT
	db CRED_SPECIAL, CRED_LIJI, CRED_NITZAN, CRED_TEXT_FADE
	db CRED_SPECIAL, CRED_PRET, CRED_ELBOIM, CRED_TEXT
	db CRED_FIND_US_AT, CRED_FIND_US_AT_2, CRED_GITHUB_LINK, CRED_GITHUB_LINK_2, CRED_TEXT_FADE
	db CRED_FIND_US_AT, CRED_FIND_US_AT_2, CRED_GITHUB_LINK, CRED_GITHUB_LINK_2, CRED_TEXT_MON
