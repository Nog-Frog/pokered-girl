...
; FA = Show the end
	...
	db CRED_IL_TRANS, CRED_NOGA, CRED_MAAYAN, CRED_SHARON, $FD
	db CRED_IL_TRANS, CRED_NOAM, CRED_ELBOIM, $FC
	db CRED_SPECIAL, CRED_LIJI, CRED_NITZAN, $FD
	db CRED_SPECIAL, CRED_PRET, CRED_ELBOIM, $FC
	db CRED_FIND_US_AT, CRED_FIND_US_AT_2, CRED_GITHUB_LINK, CRED_GITHUB_LINK_2, $FD
	db CRED_FIND_US_AT, CRED_FIND_US_AT_2, CRED_GITHUB_LINK, CRED_GITHUB_LINK_2, $FE
